    ...
    <div className="flex justify-center">
      <div className="h-[310px] w-[350px] bg-white absolute flex flex-col items-center mt-[110px] rounded-xl shadow-2xl">
        ...
        <input
          ...
          placeholder="Number"
          className="mt-4 p-2 w-[80%] h-[12%] rounded-xl border border-gray-400 outline-none focus:ring-2 focus:ring-gray-400 appearance-none [&::-webkit-inner-spin-button]:appearance-none"
        />
        <input
          type="password"
          value={password}
          ...
          className="mt-4 p-2 w-[80%] h-[12%] rounded-xl border border-gray-400 outline-none focus:ring-2 focus:ring-gray-400"
        />
        <button
